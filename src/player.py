            ...
            if hasattr(sprite, 'hitbox'):
                if sprite.hitbox.colliderect(self.hitbox):
                    if direction == 'horizontal':
                        ...
                        self.rect.centerx = self.hitbox.centerx # Updating where the players appers on the screen
                    ...
                    if direction == 'vertical':
                        ...
                        self.rect.centery = self.hitbox.centery # Updating where the players appers on the screen
